...
////////////////////////////////////////////////////////////////////////
      sb.setLength(0);
      if (LOG.isTraceEnabled()) { LOG.trace("Getting h1..."); }
      utils.getH1(h1List, root);         // extract h1
      //h1 = sb.toString().trim();
      for(String s: h1List)
        {h1 += s;}
...
////////////////////////////////////////////////////////////////////////
    ...
    metadata.add("this is a key",h1);
    ParseData parseData = new ParseData(h1List, status, title, outlinks,
//////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////
try {
BufferedWriter writer = new BufferedWriter(new FileWriter(new File("smia"),true));
